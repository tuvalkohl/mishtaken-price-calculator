...
Calculates apartment prices according to Israeli real estate discount rules.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Calculate apartment prices with Israeli real estate discount system",
